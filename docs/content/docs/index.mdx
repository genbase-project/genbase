...
*   **Secure & Isolated Execution:** Run Kit-defined **Actions** in sandboxed environments (Docker containers) with managed dependencies and configurations.
*   **Agentic Interaction:** Interact with Modules through defined **Profiles** managed by intelligent **Agents** capable of using LLMs and executing Actions.
...
<Cards>
  ...
  />
  <Card
    href="/concepts/actions-execution"
    icon={<ZapIcon />}
  ...
  <Card
    ...
    description="Connect Modules and enable controlled sharing of resources like Workspaces and Actions."
  />
    <Card
...
flowchart TD
    ...
    class KitSvc,ModuleSvc,ProjectSvc,ProfileSvc,ActionSvc component
